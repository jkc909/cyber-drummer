...
class MainContent extends Component {
    ...
    handleVolumeChange(iter, vol){
        this.midiSounds.setDrumVolume(this.state.drums[iter],vol)
    };
	...
	onSelectInstrument(e,iter){
        let me = this
        let n = e.target.options[e.target.selectedIndex].getAttribute("value");		
        me.midiSounds.cacheDrum(n);
        let drums=me.state.drums.slice()
        drums[iter]=n
        me.setState({ drums: drums })
		me.midiSounds.player.loader.waitLoad(function(){
			me.fillBeat();
			});
	};
